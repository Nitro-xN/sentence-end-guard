...
export default {
  ...
  disable() {
    atom.config.set('sentence-end-guard-for-japanese.enable-sentence-end-guard', false)
  },

  enable() {
    atom.config.set('sentence-end-guard-for-japanese.enable-sentence-end-guard', true)
  },
