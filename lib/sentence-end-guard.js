...
export default {
  ...
  activate(state) {
    ...
    this.subscriptions.add(atom.commands.add('atom-workspace', {
      ...
      'sentence-end-guard:toggle-real-time-analysis-in-current-syntax': () => this.toggleRTAInCurrentSyntax(),
      // processTextを追加
      'sentence-end-guard:analyse-text': () => this.processText()
    }));
  ...
  toggleRTAInCurrentSyntax() {
    if(this.editorHandler != null) {
      this.editorHandler.toggleRTAInCurrentSyntax();
    }
  },
