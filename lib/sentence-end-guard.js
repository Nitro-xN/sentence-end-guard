        ...
        "warning": {
          ...
          properties: {
            "warning-range": {
              order: 1,
              title: 'Warning range',
              description: 'Setting maximum range warned duplication of sentence-end ( if 0, caution will be disabled )',
              type: 'integer',
              default: 1,
              minimum: 0
            },
        ...
        "caution": {
          ...
          properties: {
            "caution-range": {
              order: 1,
              title: 'Caution range',
              description: 'Setting maximum range cautioned duplication of sentence-end ( if 0 or le warning-range, caution will be disabled )',
              type: 'integer',
              default: 3,
              minimum: 0
            },
